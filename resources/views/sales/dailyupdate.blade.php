                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="leads" name="leads" >
                                    </div>

                                    <div class="form-group">
                                        <label for="sign_up">Total No. of Sign Up (Truck Drivers):</label>
                                        <input type="number" class="form-control" id="sign_up" name="sign_up" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="updates" name="updates" rows="4" ></textarea>
                                    </div>
